...
% Active users
params.active_user_first = 700;       % The first row of the considered user section (check the scenario description for the user row map)
...
% OFDM parameters
params.num_OFDM = 32;                % Number of OFDM subcarriers
